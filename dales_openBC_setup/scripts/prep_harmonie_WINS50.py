    ...
    with xr.open_mfdataset(f"{input['inpath']}{var}.*.nc",chunks={"time": input['tchunk']}) as ds:
      ...
      if(var==variables[0]):
        ...
        transform = Transform(parameters={
            ...
            'false_easting': 649537.430110,
            'false_northing': 1032885.198586,
            'earth_radius': 6371229.0,
            'proj4': "+proj=lcc +lat_1=52.500000 +lat_2=52.500000 +lat_0=52.500000 "
             "+lon_0=.000000 +k_0=1.0 +x_0=649537.430110 +y_0=1032885.198586 "
             "+a=6371229.000000 +b=6371229.000000",
